...
This page was generated by `nbsphinx` from a Jupyter notebook.

View the `notebook on Github
<https://github.com/vispy/jupyter_rfb/tree/main/{{ env.docname }}.ipynb>`_,
or `download
<https://raw.githubusercontent.com/vispy/jupyter_rfb/main/{{ env.docname }}.ipynb>`_
the notebook.
"""
